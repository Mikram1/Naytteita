...
public class XMLParser {
	...
	/**
	 * Rajaa listan sanat 6-9 pituisiin sanoihin. Lisää väh. 1 numeron ja tekee ison kirjaimen, jotta salasanavaatimus täyttyy. (väh. 8 kirjainta, väh. 1 numero, väh. 1 iso kirjain).
	...
	/**
	 * Palauttaa väh 15 merkkiä pitkän salasanan
	...
	/**
	 * Kutsuu main-funktiota. Tein tän toisesta paketista kutsumista varten.
	 */
